#
# Module manifest for module 'Neckross365'
#
# Generated by: Juan.Sifuentes
#
...
@{
    ...
    FunctionsToExport = @(
        ...
        'Get-MsolUserGroupLicenseErrorsReport'
        'Get-CASMailboxProtocols'
        'Enable-CASMailboxProtocols'
